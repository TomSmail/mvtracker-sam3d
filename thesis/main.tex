...
To support training and evaluation, we build a human-centric data engine that converts per-view SAM3D fits on Panoptic Studio \cite{joo2015panoptic} sequences into MVTracker-compatible dense trajectory supervision with explicit multi-view visibility modelling. A cross-sequence quality audit over six sequences confirms reliable track completeness and coordinate consistency.
...
\begin{itemize}
    ...
    \item Training steps: 5,000 (approximately 13 epochs over 4 Panoptic training scenes).
    ...
    \item Evaluation frequency: every 500 steps.
\end{itemize}
...
To quantify the reliability of the modified AnthroTAP generation pipeline, we performed a cross-sequence quality audit over six sequences (basketball, boxes, football, juggle, softball, and tennis), comprising approximately 431M generated data points. The audit covered data completeness, temporal smoothness, multi-view coverage, visibility behaviour, and coordinate normalisation.
