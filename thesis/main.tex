...
To address feature noise from occluded views, we adapt the entropy-weighted multi-view fusion principle from MV-SAM3D \cite{li2026mvsam3dadaptivemultiviewfusion} --- originally developed for generative 3D reconstruction --- to the tracking setting: mesh vertex features are weighted by depth-consistency and feature-consensus signals rather than averaged uniformly across views, requiring no additional learnable parameters.
