#!/bin/bash
#SBATCH --job-name=eval-zerodepth-dense
#SBATCH --nodes=1
...
echo "=== Zero-depth + dense SAM3D eval: 5000 vertices instead of 500 ==="
...
PYTHONPATH=$DIR python -m mvtracker.cli.eval \
  +experiment=mvtracker_human_eval_zerodepth_dense_pc_aug
