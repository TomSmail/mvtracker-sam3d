...
echo "=== PC-Aug finetuning with lr=5e-5 (10x lower to prevent catastrophic forgetting) ==="
...
PYTHONPATH=$DIR python -m mvtracker.cli.train \
  +experiment=mvtracker_human_finetune_pc_aug_lr5e5
