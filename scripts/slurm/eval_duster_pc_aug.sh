#!/bin/bash
#SBATCH --job-name=eval-duster-aug
#SBATCH --nodes=1
...
echo "=== DUSt3R + SAM3D eval: MVTracker with DUSt3R depths + SAM3D mesh augmentation ==="
...
PYTHONPATH=$DIR python -m mvtracker.cli.eval \
  +experiment=mvtracker_human_eval_duster_pc_aug
